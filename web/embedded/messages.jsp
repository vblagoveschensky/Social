    ...
    <body>
        <table class="embedded">
            <thead>
                <tr>
                    <th><s:t m="when" />:</th>
                    <c:if test="${param.folder ne 'sentMessages'}"><th><s:t m="from" />:</th></c:if>
                        <th><s:t m="to" />:</th>
                        <th><s:t m="text" />:</th>
                    </tr>
                </thead>
                ...
                <c:forEach var="message" items="${requestScope.messages}">
                    <tr>
                        ...
                        <c:if test="${param.folder ne 'sentMessages'}"><td>${message.sender.name} ${message.sender.login}</td></c:if>
                            <td>
